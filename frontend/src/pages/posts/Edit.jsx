...
<form className='flex flex-col gap-4 mx-auto'>
  <h1 className='font-bold mt-6'>Post da modificare</h1>
...
<button type="submit" className='max-w-min px-5 py-2 text-l bg-green-500 rounded-lg focus:ring-4 focus:outline-none focus:ring-green-300 text-white'> 
Save
</button>
</form>
